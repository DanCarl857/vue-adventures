<template>
    <div id="login">
        ...
        <section>
            <div class="col1">
                <h1>Vuegram</h1>
                <p>Welcome to the <a href="#" target="_blank">Vuegram</a> sample social media web app powered by Vue.js and Firebase.
        ...
        methods: {
            ...
            signup() {
                ...
                fb.auth.createUserWithEmailAndPassword(this.signupForm.email, this.signupForm.password).then(user => {
                    ...
                    // create user obj
                    fb.usersCollection.doc(user.id).set({
                        name: this.signupForm.nae,
